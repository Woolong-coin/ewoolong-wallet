...
const SUBJECT = 'Error!';
const DESCRIPTION =
  'I encountered an error while using eWoolong. Here are the steps to re-create the issue:\n\nThe full error message:';
      ...
      <div className="ErrorScreen-content">
        ...
        <p>
          ...
          <a
            ...
            href={`mailto:support@woolongs.com?Subject=${SUBJECT}&body=${DESCRIPTION}`}
          >
            support@woolongs.com
          </a>{' '}
          if a refresh doesn't fix it (or click it anyway to open a ticket 😊). You can also submit
          an issue on our{' '}
          <NewTabLink href="https://github.com/woolong-coin/ewoolong-wallet/issues">
            GitHub Repository
          </NewTabLink>
