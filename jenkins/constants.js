...
const LINUX_FILES = [`eWoolong-${VERSION}-i386.AppImage`, `eWoolong-${VERSION}-x86_64.AppImage`];
const WINDOWS_FILES = [`eWoolong Setup ${VERSION}.exe`, `eWoolong Setup ${VERSION}.exe.blockmap`];
const OSX_FILES = [`eWoolong-${VERSION}-mac.zip`, `eWoolong-${VERSION}.dmg`, `eWoolong-${VERSION}.dmg.blockmap`];
const FLAVOR = (() => {
