...
export function getDisabledWallets(state: AppState): any {
  ...
  if (process.env.BUILD_ELECTRON) {
    addReason([SecureWalletName.WEB3], 'This wallet is not supported in the eWoolong app');
    addReason(
      [SecureWalletName.SAFE_T],
      'Coming soon. Please use the wallet.woolongs.com website in the meantime'
    );
  }
