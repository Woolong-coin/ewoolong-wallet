...
// All tokens ShapeShift carries that eWoolong agrees to support.
...
// All assets ShapeShift carries that eWoolong agrees to support.
...
// The ShapeShift ID unique to eWoolong.
...
export const SHAPESHIFT_REDIRECT_URI = 'https://woolongs.com/swap';
...
// The URL for eWoolong's proxy to conserve secret information.
