...
export const DOWNLOAD_MYCRYPTO_LINK = 'https://github.com/woolong-coin/ewoolong-wallet/releases';

export const socialMediaLinks: Link[] = [
  {
    link: 'https://twitter.com/woolongsc',
    text: 'twitter'
  },
  {
    link: 'https://www.facebook.com/woolongsc/',
    text: 'facebook'
  },
  {
    link: 'https://github.com/woolong-coin',
    text: 'github'
  },
  {
    link: discordURL,
...
export const productLinks: Link[] = [
  {
    link: 'https://legacy.woolongs.com/',
  ...
  {
    link: 'https://legacy.woolongs.com/helpers.html',
    text: translateRaw('FOOTER_HELP_AND_DEBUGGING')
  },
  {
    link: 'https://hackerone.com/woolongs',
