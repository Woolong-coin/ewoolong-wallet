...
3.  We will discuss internally and establish the severity of the vulnerability - any dispute about the classification of the vulnerability can be discussed but the woolongs team will ultimately define it.
