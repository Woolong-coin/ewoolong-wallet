...
class CustomNodeModal extends React.Component<Props, State> {
  ...
  private pollForDefaultNodes() {
    ...
    console.warn(
      "Don't panic! eWoolong Wallet is going to start a poll for default nodes on port 8545. If you don't like this feature, send us a ping at support@woolongs.com and we'll walk you through disabling it."
    );
