export enum HELP_ARTICLE {
  ...
  RUNNING_LOCALLY = 'how-to/offline/how-to-run-ewoolong-offline-and-locally',
  MIGRATE_TO_METAMASK = 'how-to/migrating/moving-from-ewoolong-to-metamask',
  MIGRATE_TO_LEDGER = 'how-to/migrating/moving-from-ewoolong-to-ledger',
  ...
  HOW_TO_USE_LEDGER = 'how-to/migrating/moving-from-ewoolong-to-ledger',
